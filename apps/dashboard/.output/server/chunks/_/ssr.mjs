...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-BigAH6SL.mjs');
...
function RootDocument({
  ...
  return /* @__PURE__ */ jsxs("html", { children: [
    /* @__PURE__ */ jsxs("head", { children: [
      /* @__PURE__ */ jsx("link", { href: "/src/style.css", rel: "stylesheet" }),
...
const $$splitComponentImporter = () => import('./index-B6skVwcV.mjs');
